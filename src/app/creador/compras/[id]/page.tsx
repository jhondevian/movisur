...
export default async function CreadorCompraDetallePage({
  params,
}: {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          ...
          <DetailItem label="Producto" value={metadata.itemName} />
          <DetailItem
            label="Tipo"
            value={
          ...
          <DetailItem label="Duracion" value={durationText} />
          ...
          <DetailItem label="Correo" value={metadata.confirmedByEmail} />
          <DetailItem
